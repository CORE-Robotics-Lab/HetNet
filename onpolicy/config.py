...
def get_config():
    ...
    Please reach each `scripts/train/<env>_runner.py` file to find private hyperparameters only used in <env>.
    ...
    Network parameters:
        ...
        --use_centralized_V
            by default True, use centralized training mode; or else will decentralize training mode.
        --stacked_frames <int>
        ...
        --use_orthogonal
            ...
            or else, will use xavier uniform initialization.
        --gain
    ...
    Render parameters:
        ...
        --use_render
            ...
            Note: something, the environment has internal render process which is not controlled by this hyper-param.
        --render_episodes <int>
    ...
    parser.add_argument("--algorithm_name", type=str, default='mappo',
                        choices=["rmappo", "mappo", "hetgat_mappo"])
    ...
    parser.add_argument("--cuda_device", type=str, default="cuda",
                        help="Name of CUDA GPU to run on.")
    ...
    parser.add_argument("--hetnet_num_heads", type=int, default=4,
                        help="Dimension of prediction heads for hetnet") 
    ...
    parser.add_argument("--use_LSTM", action='store_true', default=False,
                        help="Use LSTM instead of GRU for the policy.")
    ...
    parser.add_argument("--ppo_epoch", type=int, default=15,
                        help='N umber of ppo epochs (default: 15)')
    ...
    parser.add_argument("--log_interval", type=int, default=10,
                        help="time duration between continous twice log printing.")
    ...
    parser.add_argument("--use_render", action='store_true', default=False,
                        help="by default, do not render the env during training. If set, start render. "
                             "Note: something, the environment has internal render process which is not controlled "
                             "by this hyperparam.")
